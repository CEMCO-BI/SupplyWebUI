...
@Component({
  selector: 'app-planned-buy',
  templateUrl: './planned-buy.component.html',
  styleUrls: ['./planned-buy.component.css']
})
export class PlannedBuyComponent implements OnInit {
